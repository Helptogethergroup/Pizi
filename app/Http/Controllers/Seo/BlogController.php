...
class BlogController extends Controller
{
    public function index(Request $request)
    {
        ...
        if ($request->filled('status')) {
            ...
            elseif ($request->status === 'draft') $q->where('is_published', false);
        }
        ...
        return view('seo.blogs.index', compact('blogs', 'stats'));
    }
    ...
    public function destroy(Blog $blog)
    {
        ...
        $blog->delete();
        return redirect()->route('seo.blogs.index')->with('success', '✓ Blog deleted.');
    }
