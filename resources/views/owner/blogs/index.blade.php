...
<div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
    <div class="p-4 rounded-2xl bg-ink-950 text-cream">
        <div class="text-xs uppercase opacity-70">My Blogs</div>
...
<form class="flex flex-wrap gap-2 mb-4 bg-white p-3 rounded-xl border border-ink-900/10">
    <input name="search" value="{{ request('search') }}" placeholder="Search…" class="flex-1 min-w-[200px] px-3 py-2 rounded-lg border border-ink-900/15">
...
<table class="w-full text-sm">
    ...
    @empty
        <tr><td colspan="5" class="px-4 py-12 text-center text-ink-900/50">No blogs yet. <a href="{{ route('owner.blogs.create') }}" class="text-coral-600 font-semibold">+ Write your first one</a></td></tr>
    @endforelse
    </tbody>
</table>
</div>
